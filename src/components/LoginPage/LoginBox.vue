...
<template>
  ...
  <!-- <Flex class="w-[883px] h-[653px] shadow-2xl rounded-lg" gap="24">
    <Flex vertical class="pt-20 flex-1 pl-10 " gap="16">
    ...
    <div class="w-[392px] h-[653px] bg-[#CFC922] rounded-lg"></div>
  </Flex> -->
</template>
